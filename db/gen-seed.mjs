// Generate the initial Postgres seed from the frontend sample data. This loads
// the *existing* problems into Supabase once; after that, new problems are
// authored directly in the DB (insert via psql), and these files are historical.
//
//   node db/gen-seed.mjs > seed.sql     # then run seed.sql in Supabase / psql
//
...
lines.push('-- Initial load of the sample problems. Run after schema.sql.')
lines.push('begin;')
